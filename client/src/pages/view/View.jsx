...
export default function View({ token, identification }) {
    ...
    async function getPasswords(identification, token) {
        try {
            const response = await axios.get("https://passgennyproject.onrender.com/pass/users/" + identification + "?access_token=" + token);
    ...
    async function deletePassword(key, identification, token) {
        axios.delete("https://passgennyproject.onrender.com/pass/users/" + identification + "?access_token=" + token + "&key=" + key)
    ...
    async function updatePassword(identification, token, credentials) {
        axios.put("https://passgennyproject.onrender.com/pass/users/" + identification + "?access_token=" + token, credentials)
            .then(function (response) {
                if (response.data) {
